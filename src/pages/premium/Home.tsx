...
const Hero = () => {
  ...
  return (
    <section className="relative h-screen min-h-[600px] md:min-h-[800px] overflow-hidden">
      ...
      <a href="https://wa.me/5598991988828" target="_blank" rel="noopener noreferrer" className="fixed bottom-6 left-6 z-50 bg-[#25D366] text-white px-4 py-3 rounded-full shadow-2xl hover:bg-[#20BD5A] transition-all duration-300 flex items-center gap-2">
